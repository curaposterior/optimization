...
solution::solution(double L = NAN)
{
	// macierze
	x = L;
	g = NAN;
...
matrix solution::fit_fun(matrix(*ff)(matrix, matrix, matrix), matrix ud1 = NAN, matrix ud2 = NAN)
{
	try
	{
		++f_calls;
...
matrix solution::grad(matrix(*gf)(matrix, matrix, matrix), matrix ud1 = NAN, matrix ud2 = NAN)
{
	try
	{
		++g_calls;
...
matrix solution::hess(matrix(*Hf)(matrix, matrix, matrix), matrix ud1 = NAN, matrix ud2 = NAN)
{
	try
	{
		++H_calls;
